...
local electus = {
    support_function = {
        ...
        text_fade_animation = function(self, speed, r, g, b, a, text)
            ...
            for i=0, #text do
                local color = self:rgba_to_hex(r, g, b, a*math.abs(1*math.cos(2*speed*curtime/4+i*6/-40)))
    ...
    storage = {
        ...
        kill_say_text = {
            "You got wrecked, owned by electus.";
            "You can't handle this, dominated by electus.";
            "You're under our control, subjugated by electus.";
            "Your fate is sealed, controlled by electus.";
            "Prepare to be humiliated, subject to the might of electus.";
            "You're just a pawn, commanded by electus.";
            "Bow down to our wisdom, governed by electus.";
            "Know your place, subordinated to electus.";
            "Your destiny is written, dictated by electus.";
            "You're nothing but a puppet, enslaved by electus.";
        };
        g_aimbot_data = {};
        g_sim_ticks = {};
        g_net_data = {};
    ...
    create_menu_elements = function (self)
        ...
        self.ui.misc = {};
        self.ui.visuals = {};
        self.ui.ui_color = "\aAE858AFF"
        self.ui.tab_label = ui.new_label("AA", "Anti-aimbot angles", " ");
        self.ui.extra_switch = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ extra");
        ...
        for k, v in pairs(self.builder_state) do
            self.ui.antiaim_elements[k] = { 
                enable = ui.new_checkbox("AA", "Anti-aimbot angles", "\aFFFFFFFF [ ".. self.ui.ui_color .."electus \aFFFFFFFF-> \a989898FFenable "..self.builder_state[k].." \aFFFFFFFF]");
                antiaim_pitch = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ pitch", {"off", "default", "up", "down", "minimal", "random", "custom"});
                antiaim_pitch_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ custom pitch", -89, 89, 0, true);
                antiaim_yaw_base = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw base", {"at targets", "local view"});
                antiaim_yaw = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw", {"off", "180", "spin", "static", "180 Z", "crosshair"});
                antiaim_yaw_mode = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw modifier", {"static", "left / right", "tickbase delayed", "flick", "3 way", "5 way", "random l / r"});
                correcting_body_yaw = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ correcting body yaw");
                antiaim_yaw_static_slider = ui.new_slider("AA", "Anti-aimbot angles", "\nstatic aa", -180, 180, 0, true);
                antiaim_yaw_left_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ left yaw", -180, 180, 0, true);
                antiaim_yaw_right_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ right yaw", -180, 180, 0, true);
                antiaim_yaw_delay_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw delay", 2, 10, 0, true);
                antiaim_yaw_1way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 1 way yaw", -180, 180, 0, true);
                antiaim_yaw_2way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 2 way yaw", -180, 180, 0, true);
                antiaim_yaw_3way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 3 way yaw", -180, 180, 0, true);
                antiaim_yaw_4way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 4 way yaw", -180, 180, 0, true);
                antiaim_yaw_5way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 5 way yaw", -180, 180, 0, true);
                antiaim_yaw_jitter = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw jitter", {"off", "center", "offset", "center", "random", "skitter"});
                antiaim_yaw_jitter_mode = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw jitter modifier",  {"static", "left / right", "3 way", "5 way", "random l / r"});
                antiaim_yaw_jitter_static_slider = ui.new_slider("AA", "Anti-aimbot angles", "\nstatic aa", -180, 180, 0, true);
                antiaim_yaw_jitter_left_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ left yaw jitter", -180, 180, 0, true);
                antiaim_yaw_jitter_right_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ right yaw jitter", -180, 180, 0, true);
                antiaim_yaw_jitter_1way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 1 way yaw jitter", -180, 180, 0, true);
                antiaim_yaw_jitter_2way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 2 way yaw jitter", -180, 180, 0, true);
                antiaim_yaw_jitter_3way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 3 way yaw jitter", -180, 180, 0, true);
                antiaim_yaw_jitter_4way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 4 way yaw jitter", -180, 180, 0, true);
                antiaim_yaw_jitter_5way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 5 way yaw jitter", -180, 180, 0, true);
                antiaim_body_yaw = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ body yaw", {"off", "opposite", "jitter", "static"});
                antiaim_body_yaw_static_slider = ui.new_slider("AA", "Anti-aimbot angles", "\nstatic aa", -180, 180, 0, true);
                antiaim_roll = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ roll", -45, 45, 0, true);
                antiaim_freestanding_mode = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ fs mode/conditions", {"off", "on bind"});
                antiaim_freestanding_body_yaw = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ fs body yaw");
                antiaim_defensive_force = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ force defensive");
                antiaim_defensive = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ defensive builder");
                antiaim_pitch_defensive_override = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ pitch override");
                antiaim_pitch_defensive = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ pitch defensive", {"off", "default", "up", "down", "minimal", "random", "custom"});
                antiaim_pitch_defensive_mode = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ pitch custom modifier",  {"static", "jitter", "tickbase delayed", "flick", "3 way", "5 way", "random"});
                antiaim_pitch_slider_defensive = ui.new_slider("AA", "Anti-aimbot angles", "\npitch", -89, 89, 0, true);
                antiaim_pitch_first_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ first pitch value", -89, 89, 0, true);
                antiaim_pitch_second_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ second pitch value", -89, 89, 0, true);
                antiaim_pitch_delay_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ pitch delay", 2, 10, 0, true);
                antiaim_pitch_1way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 1 way pitch value", -89, 89, 0, true);
                antiaim_pitch_2way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 2 way pitch value", -89, 89, 0, true);
                antiaim_pitch_3way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 3 way pitch value", -89, 89, 0, true);
                antiaim_pitch_4way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 4 way pitch value", -89, 89, 0, true);
                antiaim_pitch_5way_slider = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 5 way pitch value", -89, 89, 0, true);
                antiaim_yaw_defensive_override = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw override");
                antiaim_yaw_defensive = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw defensive", {"off", "180", "spin", "static", "180 Z", "crosshair"});
                antiaim_yaw_defensive_mode = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw custom modifier",  {"static", "jitter", "tickbase delayed", "flick", "3 way", "5 way", "random"});
                antiaim_yaw_static_slider_defensive = ui.new_slider("AA", "Anti-aimbot angles", "\nstatic aa", -180, 180, 0, true);
                antiaim_yaw_first_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ first yaw value", -180, 180, 0, true);
                antiaim_yaw_second_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ second yaw value", -180, 180, 0, true);
                antiaim_yaw_delay_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw delay", 2, 10, 0, true);
                antiaim_yaw_1way_slider_defensive = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 1 way yaw value", -180, 180, 0, true);
                antiaim_yaw_2way_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 2 way yaw value", -180, 180, 0, true);
                antiaim_yaw_3way_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 3 way yaw value", -180, 180, 0, true);
                antiaim_yaw_4way_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 4 way yaw value", -180, 180, 0, true);
                antiaim_yaw_5way_slider_defensive  = ui.new_slider("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ 5 way yaw value", -180, 180, 0, true);
                antiaim_yaw_jitter_defensive_override = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ yaw jitter override");
                antiaim_yaw_jitter_defensive = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF*\a989898FF"..self.builder_state[k].."\aFFFFFFFF ~ defensive yaw jitter", {"off", "center", "offset", "center", "random", "skitter"});
                antiaim_yaw_jitter_static_slider_defensive = ui.new_slider("AA", "Anti-aimbot angles", "\nstatic aa", -180, 180, 0, true);
            }
        end;

        self.ui.visuals.watermark_size = ui.new_combobox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ watermark size", {"small"});
        self.ui.visuals.manual_arrows = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ manual arrows");
        self.ui.visuals.indicator = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ indicator");
        self.ui.visuals.indicator_color = ui.new_color_picker("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ indicator color", 154, 113, 118, 255);
        self.ui.visuals.defensive_box_color_txt = ui.new_label("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ defensive box color");
        self.ui.visuals.defensive_box_color = ui.new_color_picker("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ defensive box color", 42, 42, 90, 255);
        self.ui.visuals.defensive_first_gradient_color_txt = ui.new_label("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ defensive first gradient color");
        self.ui.visuals.defensive_first_gradient_color = ui.new_color_picker("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ defensive first gradient color", 134, 164, 241, 0);
        self.ui.visuals.defensive_last_gradient_color_txt = ui.new_label("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ defensive last gradient color");
        self.ui.visuals.defensive_last_gradient_color = ui.new_color_picker("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ defensive last gradient color", 134, 164, 241, 0);

        self.ui.misc.clantag = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ synced clantag");
        self.ui.misc.killsay = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ kill say");
        self.ui.misc.aimbot_logs = ui.new_checkbox("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ aimbot logs");
        self.ui.misc.animbreaker = ui.new_multiselect("AA", "Anti-aimbot angles", self.ui.ui_color .."electus \aFFFFFFFF~ animation breaker", {"body lean", "static in air", "legs on ground", "pitch on land"});
        ...
        self.ui.config.import = ui.new_button("AA", "Anti-aimbot angles", "\aFFFFFFFF [ ".. self.ui.ui_color .."electus \aFFFFFFFF-> config]\a989898FF import settings", function() end)
        self.ui.config.export = ui.new_button("AA", "Anti-aimbot angles", "\aFFFFFFFF [ ".. self.ui.ui_color .."electus \aFFFFFFFF-> config]\a989898FF export settings", function() end)
        self.ui.config.load = ui.new_button("AA", "Anti-aimbot angles", "\aFFFFFFFF [ ".. self.ui.ui_color .."electus \aFFFFFFFF-> config]\a989898FF load", function() end)
        self.ui.config.save = ui.new_button("AA", "Anti-aimbot angles", "\aFFFFFFFF [ ".. self.ui.ui_color .."electus \aFFFFFFFF-> config]\a989898FF save", function() end)
        self.ui.config.delete = ui.new_button("AA", "Anti-aimbot angles", "\aFFFFFFFF [ ".. self.ui.ui_color .."electus \aFFFFFFFF-> config]\a989898FF delete", function() end)
        self.ui_config = {
            general = {};
            keys_table = {};
            misc = {};
...
do_watermark = function(self)
    ...
    -- Spaced text
    local spaced_text = "E L E C T U S"

    -- Animate fading from black (0, 0, 0) to desired color (154, 113, 118)
    local electus_text = self.support_function:text_fade_animation(1, 154, 113, 118, 255, spaced_text)

    local beta_text = "[BETA]"

    -- Measure widths using plain (non-animated) version
    local electus_w, electus_h = renderer.measure_text(nil, spaced_text)
    local beta_w, beta_h = renderer.measure_text("c-", beta_text)

    local total_w = electus_w + beta_w
    local pos_x = screen_x - total_w - 1      -- Right edge with a little padding
    local pos_y = screen_y / 2 - electus_h / 2 -- Centered vertically

    local alignment = ui.get(self.ui.visuals.watermark_size) == "small" and "cb" or "+cb"

    renderer.text(pos_x, pos_y, 0, 0, 0, 0, alignment, nil, electus_text)

    renderer.text(pos_x + electus_w - 7 , pos_y, 174, 77, 83, 255, alignment, "c-", beta_text)
end;
    ...
    do_callback = function (self)
        ...
        client.set_event_callback("paint_ui", function ()
            if ui.is_menu_open() then
                ...
                if self.storage.tab_system.cur_tab == 1 then
                    ui.set(self.ui.tab_label, "hi "..self.support_function:text_fade_animation(1, 154, 113, 118, 255, _G.electus_username).." \aFFFFFFFF~ anti aim")
                elseif self.storage.tab_system.cur_tab == 2 then
                    ui.set(self.ui.tab_label, "hi "..self.support_function:text_fade_animation(1, 154, 113, 118, 255, _G.electus_username).." \aFFFFFFFF~ visuals")
                elseif self.storage.tab_system.cur_tab == 3 then
                    ui.set(self.ui.tab_label, "hi "..self.support_function:text_fade_animation(1, 154, 113, 118, 255, _G.electus_username).." \aFFFFFFFF~ misc")
                elseif self.storage.tab_system.cur_tab == 4 then
                    ui.set(self.ui.tab_label, "hi "..self.support_function:text_fade_animation(1, 154, 113, 118, 255, _G.electus_username).." \aFFFFFFFF~ config")
                end
        ...
        client.set_event_callback('aim_hit', function (e)
            ...
            if ui.get(self.ui.misc.aimbot_logs) then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, string.format('[%d] Hit %s\'s %s for %i(%d) (%i remaining) aimed=%s(%s) sp=%s LC=%s TC=%s', e.id, name, hgroup, e.damage, on_fire_data.damage, health, aimed_hgroup, hitchance, on_fire_data.safe_point, on_fire_data.self_choke, on_fire_data.choke))
            end
        end)
        client.set_event_callback('aim_miss', function (e)
            local on_fire_data = self.storage.g_aimbot_data[e.id]
            ...
            if ui.get(self.ui.misc.aimbot_logs) then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, string.format('[%d] Missed %s\'s %s(%i)(%s) due to %s', e.id, name, hgroup, on_fire_data.damage, hitchance, e.reason))
            end
        end)
    ...
    __init__ = function (self)
        ...
        self:do_icons_setup();
        self:do_callback();
        self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' You have logged on ', {154, 113, 118, _G.electus_username})

        table.insert(self.storage.presets, { name = "~ Default (4/11/24)", config = ""})
        ...
        ui.set_callback(self.ui.config.load, function()
            ...
            if pcall(protected) then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Config successfully loaded')
            else
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to load the config')
            end
        end)
        ui.set_callback(self.ui.config.save, function()
            ...
            if name:match("[^%w]") ~= nil then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to get config char')
                return
            end
            ...
            if pcall(protected) then
                ui.update(self.ui.config.list, self:get_config_list())
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Config successfully saved')
            else
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to save the config')
            end
        end)
        ui.set_callback(self.ui.config.delete, function()
            ...
            if self:delete_config(name) == false then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to delete config')
                ui.update(self.ui.config.list, self:get_config_list())
                return
            end
            ...
            if pcall(protected) then
                ...
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Config successfully deleted')
            else
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to delete config')
            end
        end)
        ui.set_callback(self.ui.config.import, function()
            ...
            if pcall(protected) then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Config successfully imported')
            else
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to import config')
            end
        end)
        ui.set_callback(self.ui.config.export, function()
            ...
            if pcall(protected) then
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Config successfully exported')
            else
                self.support_function:color_print( {255, 255, 255, '['}, {154, 113, 118, ' Electus '}, {255, 255, 255, ']'}, ' Failed to export config')
            end
        end)
